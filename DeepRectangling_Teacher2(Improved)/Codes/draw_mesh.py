...
#     test_mesh_primary, test_warp_image_primary, test_warp_mask_primary, test_mesh_mid, test_warp_image_mid, test_warp_mask_mid, test_mesh_final, test_warp_image_final, test_warp_mask_final = RectanglingNetwork(test_input, test_mask)
...
with tf.Session(config=config) as sess:
    ...
    def inference_func(ckpt):
        ...
        for i in range(0, length):
            ...
            # mesh_primary, warp_image_primary, warp_mask_primary, mesh_mid, warp_image_mid, warp_mask_mid, mesh_final, warp_image_final, warp_mask_final  = sess.run([test_mesh_primary, test_warp_image_primary, test_warp_mask_primary, test_mesh_mid, test_warp_image_mid, test_warp_mask_mid, test_mesh_final, test_warp_image_final, test_warp_mask_final], feed_dict={test_inputs_clips_tensor: input_clip})
            ...
            mesh_primary, warp_image_primary, warp_mask_primary, mesh_mid, warp_image_mid, warp_mask_mid = sess.run(
                [test_mesh_primary, test_warp_image_primary, test_warp_mask_primary, test_mesh_mid, test_warp_image_mid,
                 test_warp_mask_mid], feed_dict={test_inputs_clips_tensor: input_clip})
            ...
            path = "./result/final_mesh/" + str(i+1).zfill(5) + ".jpg"
