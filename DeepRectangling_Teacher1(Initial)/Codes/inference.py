...
with tf.Session(config=config) as sess:
    ...
    def inference_func(ckpt):
        ...
        for i in range(0, length):
            ...
            # fusion[..., 1] = warp_gt[..., 1] * 0.5 + warp_image[..., 1] * 0.5
            # fusion[..., 2] = warp_gt[..., 2]
        ...
        # arrResult = np.concatenate([[psnr_list], [ssim_list]], axis=0)
        # print("arrResult:", arrResult.shape)
        # path_Evl_Index = "../result/EvlIndex.npy"
        # np.save(path_Evl_Index, arrResult)
